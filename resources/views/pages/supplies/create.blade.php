            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <form action="{{url('/supplies-store')}}" class="form-body" method="POST" autocomplete="off">
                            @csrf 
                            <div class="input-group">
                                <label for="stock_no"><strong>Stock No:</strong></label>
                                <input type="text" name="stock_no" class="form-control @error('stock_no') is-invalid @enderror" placeholder="{{ $errors->first('stock_no') }}">
                            </div>
                            <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="balance_before" class="form-control @error('balance_before') is-invalid @enderror" placeholder="{{ $errors->first('balance_before') }}">
                            </div>
                            <div class="input-group">
                                <label for="delivered"><strong>Delivered:</strong></label>
                                <input type="text" name="delivered" class="form-control @error('delivered') is-invalid @enderror" placeholder="{{ $errors->first('delivered') }}">
                            </div>
                            <div class="input-group">
                                <label for="issued"><strong>Issued:</strong></label>
                                <input type="text" name="issued" class="form-control @error('issued') is-invalid @enderror" placeholder="{{ $errors->first('issued') }}">
                            </div>
                            <div class="input-group">
                                <label for="balance_after"><strong>Balance After:</strong></label>
                                <input type="text" name="balance_after" class="form-control @error('balance_after') is-invalid @enderror" placeholder="{{ $errors->first('balance_after') }}">
                            </div>
                            <div>
