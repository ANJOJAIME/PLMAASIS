                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('/supplies/'.$supply->stock_no)}}" class="form-body" method="POST">
                                @csrf 
                                @method ('PUT') 
                                <div class="input-group">
                                    <label for="stock_no"><strong>Stock No:</strong></label>
                                    <input type="text" name="stock_no" value="{{ old('stock_no', $supply->stock_no) }}" class="form-control @error('stock_no') is-invalid @enderror">
                                    @error('stock_no')
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="balance_before" value="{{ $supply->balance_before }}" class="form-control @error('balance_before') is-invalid @enderror">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="delivered" value="{{ $supply->delivered }}" class="form-control @error('delivered') is-invalid @enderror">
                                    @error('delivered')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="issued" value="{{ $supply->issued }}" class="form-control @error('issued') is-invalid @enderror">
                                    @error('issued')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="balance_after" value="{{ $supply->balance_after }}" class="form-control @error('balance_after') is-invalid @enderror">
                                    @error('balance_after')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
